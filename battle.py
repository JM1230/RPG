                ...
                while 1:
                    ...
                    if index == 0:
                        ...
                        if spell.type == "white":
                            ...
                            if foe[enemy].get_mp() < magic_dmg:
                                magic_dmg = foe[enemy].get_mp()
            ...
            if enemy.stunned is True:
                ...
                while 1:
                    ...
                    if enemy_choice == 0:
                        ...
                        dodge_endline = 13
                        if ally[target].temp_dodge is True:
